...
function displayComments() {
  ...
  console.log("display comments function has been called");

  console.log(comments[0].body);

  //applying iteration on the array comments
  for (singleObj of comments) {
    console.log(singleObj.body);
    contentStr = contentStr +
      `
      <p>Post Id : ${singleObj.postId}</p>
      <p>Name : ${singleObj.name}</p>
      <p>Email : ${singleObj.email}</p>
      <p>Comment : ${singleObj.body}</p>
      <hr>
      `
  }

  contentArea.innerHTML = contentStr;
}