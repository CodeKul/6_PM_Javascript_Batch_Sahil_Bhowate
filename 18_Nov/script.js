...
//this is the input tag where the id is entered
...
function deleteRecord() {
  console.log("deleteRecord function has been called");

  let requiredId = deleteIdInput.value;

  console.log("requiredId is ", requiredId);

  let deleteUrl = `http://localhost:3000/students/${requiredId}`;

  //sending the delete request using axios
